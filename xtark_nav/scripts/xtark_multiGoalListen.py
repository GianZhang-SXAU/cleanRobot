...
class MultiGoalListen:
    ...
    def __init__(self):
        ...
        #self.r.hset('GoalState', attr_dict)
        self.r.hset('GoalState', 'mode','order')
        self.r.hset('GoalState', 'loopWay','auto')
        self.r.hset('GoalState', 'isNavNext', 0)
        self.r.hset('GoalState', 'currentState', 'stopped')
        self.r.hset('GoalState', 'goalQueue', 'GoalQueueA')
        self.r.hset('GoalState', 'priorGoalQueue', 'GoalQueueB')
        self.r.hset('GoalState', 'currentQueue', '')
        self.r.hset('GoalState', 'currentGoal', '')
        self.r.hset('GoalState', 'successNum', '0')
        self.r.hset('GoalState', 'failedNum', '0')
        self.r.hset('GoalState', 'intervalTime', '3')
